...
- [KnightOS](https://github.com/knightmar/knightos) A x86 kernel base i'm coding for fun, the idea is to use the least possible libs and have a as possible working thing at the end.
- [Knight3D](https://github.com/knightmar/knight3d) A rust opengl glfw learning project, I'm planning to make a 3D physics engine from it, later on. 
